...
var htmlLineArr = [
	...
	'<div class="w3-panel w3-round-large w3-center" style="margin: 0px; width: 450px; height: 100px; padding-top: 25px; background-color: #e5f0fe;">',
	'<span style="font-size: 40px; color: #223a9d;">',
	'</span></div></div><div class="w3-col l6"><span style="font-size: 28px; color: #9e9e9e;">CCS Read Bases</span><br>',
	'<span style="font-size: 62px; color: #00a8a6;">',
	'</span></div></div></div><div class="w3-col l6"><div class="w3-row"><div class="w3-col l4"><span style="font-size: 28px; color: #9e9e9e;">CCS Reads</span><br>',
  ...
  'use strict'
	...
	for(var idx in inputIdxArr){
		statisticsDataAll.push({
			"sdata":ccs_read_statistics.data[ inputIdxArr[idx] ],
			"lengthChart":ccs_read_length_distribution_chart_list[ inputIdxArr[idx] ],
			"qualityChart":ccs_read_quality_distribution_chart_list[ inputIdxArr[idx] ]
		});
	}
	    ...
	    options: {
	    	...
	    	scales: {
	    		yAxes:[ { 
	    			...
	    			grid:{ display:true, borderColor: 'rgba(246,249,253,0)' } 
    			} ],
    			xAxes:[ { 
    				ticks:{ color : '#9e9e9e', fontSize: 28 }, 
    				grid:{ display: false } 
