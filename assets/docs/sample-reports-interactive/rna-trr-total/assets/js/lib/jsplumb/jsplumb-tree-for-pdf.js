...
$.jsPlumbTree = function(_jsPlumb, options) {
    ...
    this._traverseBranch = function(node, offsetLeft, offsetTop, connect) {
        ...
        setTimeout( this._traverseBranch2(node, offsetLeft, connect) , 1000);
    };

    this._traverseBranch2 = function(node, offsetLeft, connect) {

        console.log("m_cnt_test = "+m_cnt_test);
        m_cnt_test++;
        ...
        if (firstChild) {
            ...
            setTimeout( this._traverseBranch2(child, left, connect) , 0);
        ...
        if (nextSibling) {
            ...
            setTimeout( this._traverseBranch2(sibling, offsetLeft, connect) , 0);
